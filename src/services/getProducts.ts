...
export function getProductFromId (id: number): Promise<ProductType> {
...
export function getProducts (category: SearchProductType['category'], page = 0, limit = 30): Promise<ProductType[]> {

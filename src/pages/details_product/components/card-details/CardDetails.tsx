...
import { ButtonCart, Select } from '@/components'
        ...
        <article className='details bg-primary'>
          <header className='details__header'>
            <nav className='details__header__nav'>
              <Link to={'/'} className='not-decoration link text-sm medium text-navy-500'>Home</Link>
              <h6 className='text-sm light font-primary'>{'>'}</h6>
              <Link to={`/${product.category}`} className='not-decoration link text-sm medium text-navy-500'>{product.category}</Link>
              <h6 className='text-sm light font-primary'>{'>'}</h6>
              <Link to={`/${product.category}`} className='not-decoration link text-sm medium text-navy-500'>{product.brand}</Link>
            </nav>
            <div>
